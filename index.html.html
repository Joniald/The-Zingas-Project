...
<div class="row">
 <div class="col-lg-4" >
  <ul class="nav justify-content-center">
    <li class="nav-item"><a href="index.html">JEWELLERY</a></li>
 ...
 <div class="col-lg-4" >
   <ul class="nav justify-content-center">
     <li class="nav-item"><i id="ii" class="fab fa-facebook-f"><a href="https://www.facebook.com/thezingasproject"></a></i></li>
...
<!--<div id="demo" class="carousel slide justify-content-center" data-ride="carousel" style="background-color:rgba(0,0,0,0.5);">-->
